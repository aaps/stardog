...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "stardog.py"
 
        #Name of program
        self.project_name = "Stardog"
 
        #Project url
        self.project_url = "http://code.google.com/p/stardog/"
 
        #Version of program
        self.project_version = "0.2010.11.30.2"
 
        #License of the program
        self.license = "GPL 3.0"
 
        #Auhor of program
        self.author_name = "Shanti Pothapragada"
        self.author_email = "themissinglint@example.com"
        self.copyright = "Copyright (c) 2010 Shanti Pothapragada."
