...
PARTS = [LeftCannon, Engine, Gyro, Generator, Battery, Shield,
		RightLaser, MissileLauncher, MachineGun, FighterShield,
		LeftFlakCannon, Tank]
...
NON_PROPELLANT = [Gun, Engine, Gyro, Battery, Generator, Shield]

class Adjective:
	level = 1
	types = [Gun, Engine, Gyro, Battery, Generator, Cockpit, Shield, Tank]
