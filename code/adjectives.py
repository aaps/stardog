...
CARGO = [Scrap, Iron, IronOre, Chemicals, Food, Gems, ExMetal, SheetMetal,
         ConstMat, CompComp, MachParts, Plastics, Explosives, Minerals,
         AirFilters, PleasureCubes, Alcohol, Textiles, Alcohol, HuskarCigars,
         Alcohol, ServantDroids, CloningDevice, PureWater, Aluminium,
         AluminiumOre, Titanium, TitaniumOre]
